...
var $author$project$Main$isPalindrome = function (word) {
	return _Utils_eq(
		$elm$core$String$reverse(word),
		word);
};
var $author$project$Main$isPairPalindrome = F2(
	function (word, other) {
		return $author$project$Main$isPalindrome(
			_Utils_ap(word, other));
	});
		...
		[
			...
			function (_v0) {
				return A2(
					...
					$author$project$Main$isPalindrome('racecar'),
					true);
			}),
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					$author$project$Main$isPalindrome('banana'),
					false);
			}),
			A2(
			$elm_explorations$test$Test$test,
			'isPairPalindrome code edoc',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					A2($author$project$Main$isPairPalindrome, 'code', 'edoc'),
					true);
			})
		]));
...
var $author$project$Test$Generated$Main2398912907$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		paths: _List_fromArray(
			['/Users/lineville/work/daily-challenge/elm/2020/march/mar-29/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: $elm$core$Maybe$Nothing,
		seed: 373511145195716
	},
...
_Platform_export({'Test':{'Generated':{'Main2398912907':{'init':$author$project$Test$Generated$Main2398912907$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "/tmp/elm_test-45845.sock";
